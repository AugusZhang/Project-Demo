...
- (NSArray *)viewControllersForTabBar {
    NetworkDemoController *firstViewController = [[NetworkDemoController alloc] initWithNibName:@"NetworkDemoController" bundle:nil];
    UIViewController *firstNavigationController = [[CYLBaseNavigationController alloc]
                                                   initWithRootViewController:firstViewController];
    [firstViewController cyl_setHideNavigationBarSeparator:YES];
    // [firstViewController cyl_setNavigationBarHidden:YES];
    NetworkDemoController *secondViewController = [[NetworkDemoController alloc] initWithNibName:@"NetworkDemoController" bundle:nil];
    ...
    NetworkDemoController *thirdViewController = [[NetworkDemoController alloc] initWithNibName:@"NetworkDemoController" bundle:nil];
    ...
    NetworkDemoController *fourthViewController = [[NetworkDemoController alloc] initWithNibName:@"NetworkDemoController" bundle:nil];
